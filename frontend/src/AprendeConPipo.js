    ...
    return (
        <div style={{ display: 'flex', minHeight: '100vh' }}>
            ...
            <div style={{ flex: 1, marginLeft: 210, display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
                <div style={{ maxWidth: 1100, margin: '40px auto', background: '#fffbe7', borderRadius: 24, boxShadow: '0 8px 24px #ffd54f', padding: 36, border: '3px dashed #ff4081', position: 'relative', display: 'flex', flexDirection: 'row', alignItems: 'flex-start' }}>
                    {/* Imagen de Pipo a la izquierda */}
                    <div style={{ minWidth: 180, marginRight: 32, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        <img src="/Premio1.png.webp" alt="Pipo" style={{ width: 160, height: 'auto', borderRadius: 18, boxShadow: '0 4px 16px #ffd54f88', background: '#fff' }} />
                    </div>
