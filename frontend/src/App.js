                        ...
                        <Route path="/" element={
                            !usuario ? (
                                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', background: '#f9f9f9' }}>
                                    <div style={{ position: 'relative', width: 1200, height: 1200, maxWidth: '99vw', maxHeight: '99vw', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                        ...
                                        {/* Formulario central */}
                                        <div style={{ position: 'absolute', left: '50%', top: '50%', transform: 'translate(-50%, -50%)', background: '#fff', borderRadius: 16, boxShadow: '0 2px 16px #ffe06633', padding: '2.2rem 2.2rem 1.7rem 2.2rem', minWidth: 320, maxWidth: 400, zIndex: 2 }}>
