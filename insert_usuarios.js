// Script para insertar los usuarios reales en la tabla 'usuarios'
...
const usuarios = [
    { nombre: 'PIPO68', email: 'pipo68@storyup.es', password: 'PaLMeRiTa1968' },
    { nombre: 'Admin', email: 'admin@storyup.es', password: 'PaLMeRiTa1968' }
];
