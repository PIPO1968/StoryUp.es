// Script para eliminar el usuario Admin (username: Admin, email: piporgz68@gmail.com)
...
(async () => {
    ...
    await client.query("DELETE FROM usuarios WHERE username = 'Admin' OR email = 'piporgz68@gmail.com'");
